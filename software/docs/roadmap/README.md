...
| [command-registry-and-shortcuts.md](command-registry-and-shortcuts.md) | Command registry, editable shortcuts, palette, recent-views switcher, About/Docs | 🟡 planned (FR-UX-10/11/12, FR-UI-20) |
