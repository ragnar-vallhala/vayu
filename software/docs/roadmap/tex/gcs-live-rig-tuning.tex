...
stack (\texttt{software/src/autotune/}), the source state machine
...
\item
  Autotune:
  \texttt{software/src/autotune/\{AutotuneEngine,Optimizer,Space,Cost,Rollout,SitlStack,AutotuneWorker\}.\{h,cpp\}}
\item
...
\item
  Commands: \texttt{software/src/protocol/CommandCodec.\{h,cpp\}},
...
\item
  ...
  (\texttt{software/src/core/Types.h})
\item
  Sim rig physics: \texttt{tools/vsim/src/physics\_core.cpp},
  \texttt{tools/vsim/include/vsim\_proto.h}
  (\texttt{vsim\_ctl\_testrig\_t})
\item
  FSM: \texttt{software/src/core/SourceController.\{h,cpp\}},
  \texttt{SourceState.h}
\end{itemize}
