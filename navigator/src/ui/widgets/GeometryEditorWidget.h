...
private:
  ...
  QDoubleSpinBox *transX_ = nullptr;
  QDoubleSpinBox *transY_ = nullptr;
  QDoubleSpinBox *transZ_ = nullptr;
  ...
  struct MotorRow {
    ...
    QDoubleSpinBox *ax = nullptr;
    QDoubleSpinBox *ay = nullptr;
    QDoubleSpinBox *az = nullptr;
    QComboBox *spin = nullptr;
    QDoubleSpinBox *kt = nullptr;
    QDoubleSpinBox *km = nullptr;
    QDoubleSpinBox *wmax = nullptr;
