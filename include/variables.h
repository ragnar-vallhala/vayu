...
// Gains
#define DEAFULT_ROLL_ANGLE_RATE_KP 0.045f
#define DEAFULT_ROLL_ANGLE_RATE_KI 0.004f
#define DEAFULT_ROLL_ANGLE_RATE_KD 0.003f
#define DEAFULT_ROLL_ANGLE_RATE_KFF 0.1f
#define DEAFULT_ROLL_ANGLE_RATE_I_MAX 0.06f
#define DEAFULT_ROLL_ANGLE_RATE_D_MAX 0.25f
#define DEAFULT_ROLL_ANGLE_RATE_D_LPF_RC 0.12f
#define DEAFULT_ROLL_ANGLE_RATE_OUT_MIN -1.0f
#define DEAFULT_ROLL_ANGLE_RATE_OUT_MAX 1.0f

#define DEAFULT_PITCH_ANGLE_RATE_KP 0.045f
#define DEAFULT_PITCH_ANGLE_RATE_KI 0.004f
#define DEAFULT_PITCH_ANGLE_RATE_KD 0.003f
#define DEAFULT_PITCH_ANGLE_RATE_KFF 0.1f
#define DEAFULT_PITCH_ANGLE_RATE_I_MAX 0.06f
#define DEAFULT_PITCH_ANGLE_RATE_D_MAX 0.25f
#define DEAFULT_PITCH_ANGLE_RATE_D_LPF_RC 0.12f
