...
and [implement-rc-telemetry-and-gcs-ui.md](https://github.com/ragnar-vallhala/vayu-navigator/blob/main/navigator/docs/journal/changelog/implement-rc-telemetry-and-gcs-ui.md).
...
- **RC + telemetry:** iBus RC parsing (UART1 DMA circular buffer) and telemetry
  ...
  [implement-rc-telemetry-and-gcs-ui.md](https://github.com/ragnar-vallhala/vayu-navigator/blob/main/navigator/docs/journal/changelog/implement-rc-telemetry-and-gcs-ui.md).
