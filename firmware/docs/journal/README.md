...
- [`deferred/`](deferred/) — known issues consciously deferred, kept for trajectory tracking: [#1 attitude under-read in powered flight](deferred/01-attitude-estimate-underread.md), [#2 two thirds of the serial-channel .bss is never used](deferred/02-serial-handler-bss.md).
