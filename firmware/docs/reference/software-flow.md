...
> for the wire format see [navlink-v2-spec.md](https://github.com/ragnar-vallhala/navlink/blob/main/docs/reference/navlink-v2-spec.md).
...
[`navlink/dialect.json`](https://github.com/ragnar-vallhala/navlink/blob/main/dialect.json).*
