...
against the MOD-SUB-NNN rows in firmware/docs/reference/requirements.md, and
emits firmware/docs/reference/trace.md.

Per firmware/docs/reference/requirements.md §5.3 — vendor exemption:
...
CLI:
    tools/dev/trace.py                  Regenerate firmware/docs/reference/trace.md.
...
REQUIREMENTS_MD = REPO_ROOT / "firmware" / "docs" / "reference" / "requirements.md"
TRACE_MD = REPO_ROOT / "firmware" / "docs" / "reference" / "trace.md"
...
def emit_trace_md(reqs, impls, verifs, out_path: Path) -> None:
    ...
    lines.append("> Source of truth: `firmware/docs/reference/requirements.md`.")
    lines.append("")
