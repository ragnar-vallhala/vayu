...
- [`gcs-in-app-simulator-and-world-collision.md`](../../software/docs/journal/changelog/gcs-in-app-simulator-and-world-collision.md) — SITL architecture (`vsim_d` daemon).
